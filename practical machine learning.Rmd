...
From the confusion matrix, it can be seen that this model is very accurate. While experimenting with PCA and other models, it did not generate a good accuracy. 
